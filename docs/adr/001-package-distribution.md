...
## Decision
Use dual distribution: npm package (`@robotcat/godot-skills`) for pi-agent and git repository for other agents. Each skill is a self-contained directory with its own SKILL.md.
